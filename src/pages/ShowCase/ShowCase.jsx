...
let ShowCase = () => {
    ...
    const items = [
        ...
        },
        {
            ...
            off: "30",
            proExtra: "40",
            name: "Hotel Paradise-Palarivattom",
            rating: '4.6',
            imgSrc: chapathiImg
        },
        {
    ...
    return <div className={css.outerDiv}>
        ...
        <div className={css.showCaseDiv}>
            <div className={css.showcaseComps}>
                ...
                <CategorySelectionComp title="Dining" imgSrc={dinning1} imgSrc2={dinning2} color="#EDF4FF" comp='dinning' isActive={isActive} setIsActive={setIsActive} />
            </div>
        </div>
        ...
        <div className={css.innerDiv6}>
            <div className={css.w7}>
                <div className={css.innerDiv6Title}>
                    {page === orderOnlinePage ? "Delivery Restaurants in Kochi" : page === diningOutPage ? "Dine-Out Restaurants in Kochi" : "Nightlife Restaurants in Kochi"}
                </div>
